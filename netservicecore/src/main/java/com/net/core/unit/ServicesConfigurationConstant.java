...
/**
 * <br>
 * Created by xinhong.zhang on 2016/7/27.
 */
public class ServicesConfigurationConstant {
    ...
    // 是否打开广告
    public static final String OPEN_ADS = SERVICESCONFIGURATION_HEAD + "OPEN_ADS";
    // Fackbook链接
    public static final String FACKBOOK_URL = "pro_feedback_facebook";
    // Google+链接
    public static final String GOOGLE_ADD = "pro_feedback_google";
    // 检查更新周期
    public static final String UPDATE_CYCLE = SERVICESCONFIGURATION_HEAD + "UPDATE_CYCLE";
    // 服务器配置项更新周期
    public static final String CONFIGURATION_UPDATE_CYCLE = SERVICESCONFIGURATION_HEAD + "CONFIGURATION_UPDATE_CYCLE";
    // Hi boost风格
